...
describe("Tracksegment", () => {
    ...
    describe("Segment overlap", () => {
        ...
        test("It detects overlaps",() => {
            ...
            expect(doSegmentsOverlap({start:3,end:1,trackId:0},{start:0,end:2,trackId:0})).toBe(true); // Reverse track
        })
        ...
        it("Detects not overlapping", () => {
            ...
            expect(doSegmentsOverlap({start:2,end:4,trackId:0},{start:2,end:0,trackId:0})).toBe(false); // Reverse track
        })
